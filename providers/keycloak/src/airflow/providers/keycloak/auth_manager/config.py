...
from airflow.security.permissions import RESOURCE_ASSET, RESOURCE_AUDIT_LOG, RESOURCE_CONNECTION, \
    ...
    RESOURCE_PASSWORD, RESOURCE_ROLE, RESOURCE_USER, RESOURCE_ACTION, RESOURCE_HITL_DETAIL
...
ADMIN_PERMISSIONS = [
    ...
    (ACTION_CAN_ACCESS_MENU, RESOURCE_PLUGIN),
    (ACTION_CAN_READ, RESOURCE_PLUGIN),
    (ACTION_CAN_READ, RESOURCE_HITL_DETAIL),
    (ACTION_CAN_EDIT, RESOURCE_HITL_DETAIL),
    (ACTION_CAN_ACCESS_MENU, RESOURCE_HITL_DETAIL)
]
